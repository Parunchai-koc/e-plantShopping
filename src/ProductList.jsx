...
import { addItem } from './CartSlice'; // Make sure this import is correct
import { useSelector } from 'react-redux';


function ProductList() {
    const [showCart, setShowCart] = useState(false);
    const [showPlants, setShowPlants] = useState(true); // Initialize to true to show plants initially
